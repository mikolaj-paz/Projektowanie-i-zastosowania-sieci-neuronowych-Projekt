...
def visualize_all_models(srcnn_src: str, swinir_src: str, device: torch.device, hr: Image, lr: Image):
...
if __name__ == '__main__':
    ...
    visualize_all_models(args.srcnn, args.swinir, device, hr_img, lr_img)